...
function Login() {
  ...
  <div className="wrapper fadeInDown">
      ...
      <div id="formContent">
        ...
        <form>
          <input class="input" type="text" id="login" className="fadeIn second" name="login" placeholder="login" value={email} onChange={handleEmailChange}/>
          <input class="input" type="text" id="password" className="fadeIn third" name="login" placeholder="password" value={password} onChange={handlePasswordChange}/>
          <input class="input" type="submit" className="fadeIn fourth" value="Log In" />
        </form>
        <div id="formFooter">
